...
console.log("the positives are:" , positives);
console.log("the negatives are:", negatives);
...
let stretchZeroes = []
for(let j of supplyChanges){
  if(j>0){
    stretchPositives.push(j)
  }else if(j<0){
    stretchNegatives.push(j)
  }else {
    stretchZeroes.push(j)
  }
}
console.log("the positives are:" , stretchPositives);
console.log("the negatives are:", stretchNegatives);
console.log("the zeroes are:", stretchZeroes);
